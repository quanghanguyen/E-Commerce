            ...
            ScrollView(.vertical, showsIndicators: false) {
                ...
                VStack(spacing: 15) {
                    ...
                    if loginData.registerUser {
                        CustomTextField(icon: "lock", title: "Re-Enter Password", hint: "re-enter your password", value: $loginData.re_Enter_Password, showPassword: $loginData.showReEnterPassword)
                            .padding(.top, 10)
                    }
